...
class CosineAnnealingLR_with_Restart(_LRScheduler):
    ...
    def step(self, epoch=None):
        ...
        if self.current_epoch == self.Te:
            ...
            self.base_lrs = [base_lr/1.1 for base_lr in self.base_lrs]
...
out_dir='.'
take_snapshot = False 
a = CosineAnnealingLR_with_Restart(optimizer, T_max, T_mult, model, out_dir, take_snapshot, eta_min=0.001)
lr = []
