...
Round1v1::Round1v1(Monster *m, Hero *h): m(m), h(h){
    this->rounds = 0;
    this->whose_turn = 0;
...
void Round1v1::chooseLine(int no, const string &str){
...
void Round1v1::drawBattle(int round, int hero_hp, int hero_max_hp, int hero_mp, int hero_max_mp, int hero_atk,
